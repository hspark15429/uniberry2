...
import 'package:uniberry2/src/timetable/presentation/views/oldViews/MainPage/postPage/postWritePage.dart';
...
class _PostlistpageState extends State<Postlistpage> {
  ...
  void initState() {
    super.initState();
    boardPosts =
        dummyPosts.where((post) => post.category == widget.boardName).toList();
  }
                ...
                children: [
                  ...
                  if (post.imageUrls.isNotEmpty)
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.file(File(post.imageUrls.first),
                            fit: BoxFit.cover),
                      ),
                    ),
                  // 작성자 정보와 삭제 버튼
