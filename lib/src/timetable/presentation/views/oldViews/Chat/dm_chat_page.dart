...
import 'package:uniberry2/src/timetable/presentation/views/oldViews/Chat/votePage.dart'; // votePage.dart를 import 합니다.
  ...
  void _cancelMessage(types.Message message) {
    ...
    if (isCancelable) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                'Messages can only be canceled within 10 minutes of sending')),
      );
    }
  }
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  IconButton(
                    icon: Icon(_messageReactions[message.id] == 'like'
                        ? Icons.thumb_up_alt
                        : Icons.thumb_up),
                    onPressed: () {
                  ...
                  IconButton(
                    icon: Icon(_messageReactions[message.id] == 'love'
                        ? Icons.favorite
                  ...
                  IconButton(
                    icon: Icon(_messageReactions[message.id] == 'happy'
                  ...
                  IconButton(
                    icon: Icon(_messageReactions[message.id] == 'sad'
                  ...
                  IconButton(
                    icon: Icon(_messageReactions[message.id] == 'confirm'
  ...
  Widget _buildMessageItem(types.Message message) {
    ...
    final replyMessage = message.metadata?['replyingTo'] != null
        ? _messages.firstWhere(
            (msg) => msg.id == message.metadata?['replyingTo'],
