...
import 'package:uniberry2/src/timetable/presentation/views/oldViews/Chat/dm_chat_page.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/Chat/dm_chatgpt_page.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/Chat/dm_user_search_page.dart';
...
class _DMListPageState extends State<DMListPage> {
  List<ChatUser> chatUsers = [
    ChatUser(
      ...
      imageUrl:
          'https://img4.yna.co.kr/etc/inner/KR/2023/01/30/AKR20230130074900017_01_i_P4.jpg',
      time: 'Now',
    ),
    ChatUser(
      name: 'UniberryTeam',
      ...
      imageUrl:
          'https://www.uniberry.site/wp-content/uploads/2024/01/light-3.png',
      time: 'Now',
    ),
  ];
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const DMUserSearchPage()));
            },
          ),
          IconButton(
            ...
            onTap: () {
              ...
              if (chatUsers[index].name == 'UniberryAI') {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const DMChatGPTPage()));
              } else {
                // 다른 사용자를 탭했을 때의 로직
                Navigator.push(
                  context,
