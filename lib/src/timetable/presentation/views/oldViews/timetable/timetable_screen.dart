...
import 'package:uniberry2/src/timetable/presentation/views/oldViews/Grade/grade_page.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/Grade/grade_rate_chart_page.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/timetable/timetableSetting.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/timetable/timetable_coursesListPage.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/timetable/timetable_detailPage.dart';
...
class _TimetableScreenState extends State<TimetableScreen>
  ...
  void _selectSchool(BuildContext context) {
    final availableSchools = context.read<TimetableCubit>().schools;
                ...
                BlocListener<TimetableCubit, TimetableState>(
                  ...
                  child: BlocBuilder<TimetableCubit, TimetableState>(
                    builder: (context, state) {
                      ...
                      final includeSaturday = timetableCubit.includeSaturday;
