...
import 'package:uniberry2/src/timetable/presentation/views/oldViews/settiing/account/student_ID_card_back_page.dart';
import 'package:uniberry2/src/timetable/presentation/views/oldViews/settiing/account/student_ID_card_front_page.dart';
      ...
      body: Center(
        child: AnimatedSwitcher(
          ...
          child: isFront
              ...
              : StudentIDCardBackPage(
                  enrollmentDate: enrollmentDate), // enrollmentDate 전달
        ),
      ),
    );
  }
