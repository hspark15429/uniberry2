  ...
  Widget build(BuildContext context) {
    return Center(
      child: SingleChildScrollView(
        child: Container(
          width:
              MediaQuery.of(context).size.width * 0.9, // 화면의 90% 너비를 차지하도록 설정
              ...
              SingleChildScrollView(
                ...
                child: DataTable(
                  ...
                  rows: courses.asMap().entries.map((entry) {
                    ...
                    var grade = course['grade'] as String;
                    var type = course['type'] as String;
                        ...
                        DataCell(
                          SizedBox(
                            ...
                            child: TextField(
                              ...
                              onSubmitted: (value) {
                                onUpdateCourse(
                                    index, value, credits, grade, type);
                              },
                            ),
                          ),
                        ),
                        DataCell(
                          SizedBox(
                            ...
                            child: DropdownButton<int>(
                              value: credits,
                              onChanged: (value) {
                                onUpdateCourse(index, nameController.text,
                                    value!, grade, type);
                              },
