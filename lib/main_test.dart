...
class Product {
  ...
  static Product fromJson(Map<String, dynamic> json) {
    return Product(json['name'] as String, json['image_urls'][0] as String);
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    // Listen to changes in the search text field and update the query in the searcher
    ...
    // Listen to changes in the search page and append the items to the paging controller
    ...
    // Listen to changes in the paging controller and update the page in the searcher
    _pagingController.addPageRequestListener(
        (pageKey) => _productsSearcher.applyState((state) => state.copyWith(
              page: pageKey,
            )));
    // Connect the filter state to the searcher
